...
const kaiser = new Heroi("Kaiser", 30, "mago"); // Criação de uma instância de herói (objeto)
const silver = new Heroi("Silver", 25, "guerreiro"); // Criação de outra instância de herói

kaiser.atacar(); // Chamada do método de ataque para o primeiro herói
silver.atacar(); // Chamada do método de ataque para o segundo herói